    ...
    <div id="content-wrapper" className="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div className="container-fluid">
          ...
          <div className="row">
            <BasicCard data={{ value: props.data.earningsMonthly, icon: 'fa-calender', cardBorder: 'primary' }} />
            <BasicCard data={{ value: props.data.earningsAnnual, icon: 'fa-calender', cardBorder: 'success' }} />
